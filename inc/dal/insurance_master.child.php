...
require_once('baseclasses/insurance_master.php');

class insuranceMasterChild extends insurance_master
{ 	// class : begin
...
$query = "SELECT $this->selectColumn FROM insurance_master WHERE ";
$condition= $this->condition;
$param = $this->param;
	if (is_array($condition)) 
	{
...
$this->id = "" ;
	try
	{
		...
		$sql = $this->conn->prepare("INSERT INTO insurance_master (" . implode(", ", $columnNames) . ") VALUES " . implode(", ", $rowsSQL));
