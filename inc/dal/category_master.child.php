...
require_once('baseclasses/category_master.php');

class categoryMasterChild extends category_master
{ 	// class : begin
...
$query = "SELECT $this->selectColumn FROM category_master WHERE ";
$condition= $this->condition;
$param = $this->param;
	if (is_array($condition)) 
	{
...
$this->id = "" ;
	try
	{
		...
		$sql = $this->conn->prepare("INSERT INTO category_master (" . implode(", ", $columnNames) . ") VALUES " . implode(", ", $rowsSQL));
