...
require_once('baseclasses/settings.php');

class settingsChild extends settings
{ 	// class : begin
...
$query = "SELECT $this->selectColumn FROM settings WHERE ";
$condition= $this->condition;
$param = $this->param;
	if (is_array($condition)) 
	{
...
$this->id = "" ;
	try
	{
		...
		$sql = $this->conn->prepare("INSERT INTO settings (" . implode(", ", $columnNames) . ") VALUES " . implode(", ", $rowsSQL));
