...
require_once('baseclasses/department_master.php');

class departmentMasterChild extends department_master
{ 	// class : begin
...
$query = "SELECT $this->selectColumn FROM department_master WHERE ";
$condition= $this->condition;
$param = $this->param;
	if (is_array($condition)) 
	{
...
$this->id = "" ;
	try
	{
		...
		$sql = $this->conn->prepare("INSERT INTO department_master (" . implode(", ", $columnNames) . ") VALUES " . implode(", ", $rowsSQL));
