...
require_once('baseclasses/city.php');

class cityChild extends city
{ 	// class : begin
...
$query = "SELECT $this->selectColumn FROM city WHERE ";
$condition= $this->condition;
$param = $this->param;
	if (is_array($condition)) 
	{
...
$this->id = "" ;
	try
	{
		...
		$sql = $this->conn->prepare("INSERT INTO city (" . implode(", ", $columnNames) . ") VALUES " . implode(", ", $rowsSQL));
