...
require_once('baseclasses/country.php');

class countryChild extends country
{ 	// class : begin
...
$query = "SELECT $this->selectColumn FROM country WHERE ";
$condition= $this->condition;
$param = $this->param;
	if (is_array($condition)) 
	{
...
$this->id = "" ;
	try
	{
		...
		$sql = $this->conn->prepare("INSERT INTO country (" . implode(", ", $columnNames) . ") VALUES " . implode(", ", $rowsSQL));
