...
require_once('baseclasses/contract_master.php');

class contractMasterChild extends contract_master
{ 	// class : begin
...
$query = "SELECT $this->selectColumn FROM contract_master WHERE ";
$condition= $this->condition;
$param = $this->param;
	if (is_array($condition)) 
	{
...
$this->id = "" ;
	try
	{
		...
		$sql = $this->conn->prepare("INSERT INTO contract_master (" . implode(", ", $columnNames) . ") VALUES " . implode(", ", $rowsSQL));
